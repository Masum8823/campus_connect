...
<head>
    ...
    <style>
        ...
        .profile-link { text-decoration: none; transition: 0.2s; }
        .profile-link:hover .alumni-name { color: var(--primary-color) !important; text-decoration: underline; }
            ...
            <div class="col-md-9 col-lg-8">
                    ...
                    ?>
                        <div class="card journey-card">
                            <div class="card-body p-4 p-lg-5">
                                <!-- UPDATED: Clickable Alumni Header -->
                                <a href="../user/profile.php?id=<?php echo $row['user_id']; ?>" class="profile-link d-flex align-items-center mb-4">
                                    ...
                                    <div>
                                        <h5 class="mb-0 fw-bold text-dark alumni-name"><?php echo $row['full_name']; ?></h5>
                                ...
                                <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                                    <a href="toggle_inspire.php?id=<?php echo $sid; ?>" class="btn btn-sm <?php echo $is_inspired ? 'btn-danger' : 'btn-outline-danger'; ?> rounded-pill px-3 fw-bold">
                                        <i class="bi <?php echo $is_inspired ? 'bi-heart-fill' : 'bi-heart'; ?> me-1"></i> Inspired (<?php echo $count_res['total']; ?>)
                                    </a>
                ...
                <?php else: ?>
                    <div class="text-center py-5 bg-white rounded-4 shadow-sm border">
                        ...
                        <p class="text-muted mt-3">No inspirational stories found.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
