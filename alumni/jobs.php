...
if($search){
    ...
    $sql .= " AND (job_title LIKE '%$safe_search%' OR company LIKE '%$safe_search%' OR target_dept LIKE '%$safe_search%')";
}
            ...
            <div class="col-md-7">
                <form method="GET">
                    <div class="input-group">
                        ...
                        <button class="btn btn-primary rounded-pill px-4 ms-2 fw-bold" type="submit">Search</button>
                    </div>
                </form>
            </div>
        </div>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card job-card p-4">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                ...
                                <?php if($job['alumni_id'] == $current_user_id || $user_role == 'admin'): ?>
                                    <div class="d-flex gap-2">
                                        <a href="edit_job.php?id=<?php echo $job['id']; ?>" class="text-muted" title="Edit"><i class="bi bi-pencil-square"></i></a>
                                        <a href="delete_job.php?id=<?php echo $job['id']; ?>" class="text-danger" title="Delete" onclick="return confirm('Delete?')"><i class="bi bi-trash"></i></a>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <h4 class="fw-bold mb-1">
                                <a href="view_job.php?id=<?php echo $job['id']; ?>" class="text-dark text-decoration-none"><?php echo $job['job_title']; ?></a>
                            </h4>
                            ...
                            <p class="small text-secondary mb-4 flex-grow-1">
                                <?php echo nl2br(substr($job['description'], 0, 160)); ?>...
